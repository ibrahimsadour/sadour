...
<section id="contact_sec" class="contact-sec sec-pad-top-sm">
    ...
    <div class="row">
        <div id="form_card_height" class="col-sm-7 mb-30 ">
            <div  class="mdl-card mdl-shadow--2dp border-top-blue" data-ng-controller="ContactController">
                <h4 class="mb-10 font-unsetcase">@lang('site.contact_title')</h4>
                @if(count($errors) > 0)
                ...
                {{csrf_field()}}
                        ...
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label form-group">
                            ...
                            <label class="mdl-textfield__label" for="inputName">@lang('site.contact_name')*</label>
                        </div>	
                        ...
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label form-group">
                            ...
                            <label class="mdl-textfield__label" for="inputEmail">@lang('site.contact_email')*</label>
                        </div>
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label form-group">
                            <textarea 
                            data-ng-model="formData.inputMessage" 
                            class="mdl-textfield__input"  rows="3" id="inputMessage" name="message" required></textarea>
                            <label class="mdl-textfield__label" for="inputMessage">@lang('site.contact_messege')*</label>
                        </div>
        ...
        <div class="col-sm-5 mb-30">
            <div class="mdl-card mdl-shadow--2dp pa-0 border-top-blue">
