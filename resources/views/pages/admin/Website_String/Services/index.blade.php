                        ...
                        <main class="content">
                                ...
                                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
                                    <div class="d-block mb-4 mb-md-0">
                                        ...
                                        <p class="mb-0">Your web Services dashboard template.</p>
                                    </div>
                                    <div class="btn-toolbar mb-2 mb-md-0">
                                    @role('Admin')
                                    <div class="btn-group">
                                        <form method="get" action="{{route('admin.services.create')}}" style="margin-right: 10px;">
                                            <button  class="btn btn-sm btn-outline-primary"> Add New Services  <span class="icon icon-sm icon-gray"><i class="fas fa-plus"></i></span></button>
                                        </form>
                                        ...
                                        @isset($services)
                                            @foreach($services as $row)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="font-weight-normal">{{$row['description']}}</span>
                                                    </td>
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item" href="{{route('admin.services.show',$row -> id)}}"><span class="fas fa-eye mr-2"  style="color:#17a2b8;" ></span>View Details</a>
                                                                @hasanyrole('Editor|Admin')
                                                                <a class="dropdown-item" href="{{route('admin.services.edit',$row -> id)}}"><span class="fas fa-edit mr-2" style="color:#007bff;"></span>Edit</a>
                                                                @endhasanyrole

                                                                @role('Admin')
                                                                <a class="dropdown-item" href="{{route('admin.services.delete',$row -> id)}}"><span class="fas fa-trash-alt mr-2" style="color:#dc3545;"></span>Remove</a>
                                                                
                                                                    @if($row -> active == 0)
                                                                        <a href="{{route('admin.services.status',$row -> id)}}"
