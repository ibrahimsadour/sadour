                        ...
                        <!--/Setting-->
                                ...
                                <div class="row">
                                    <div class="col-md-12" style="max-width: 50%;"> 
                                        <br />
                                        <h3 aling="center">Add Services</h3>
                                        <br />
                                        @if(count($errors) > 0)
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> Service Title - {{__('messages.'.$lang -> abbr)}} </label>
                                                            <input type="text" value="" id="titel"
                                                                    class="form-control"
                                                                    placeholder="  "
                                                                    name="service[{{$index}}][titel]">
                                                            @error("service.$index.name")
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea  name="service[{{$index}}][description]" class="form-control" placeholder=" description" requiredrows="4" cols="50" ></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 hidden">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="abbr"
                                                                    ...
                                                                    placeholder="  "
                                                                    value="{{$lang -> abbr}}"
                                                                    name="service[{{$index}}][abbr]">

                                                            @error("service.$index.abbr")
