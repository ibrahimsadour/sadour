                                ...
                                <!--/Setting-->
                                   ...
                                   <div class="row">
                                          <div class="col-md-12" style="max-width: 50%;">
                                                 ...
                                                 <form method="post" action="{{action('WatIkDoe\WatIkDoeController@update',['watikdoe' => $website_watikdoe->id])}}">
                                                        {{csrf_field()}}
                                                        {{ method_field('PATCH') }}
                                                        <div class="form-group">
                                                        <label for="name">Title </label>
                                                        <input type="text" name="titel" class="form-control" value="{{$website_watikdoe->titel}}" placeholder="Enter name" />
                                                        </div>
 
                                                        <div class="form-group">
                                                        <label for="name">Description</label>
                                                        <textarea  name="description" class="form-control"  value="{{$website_watikdoe->description}}"   rows="4" cols="50">{{$website_watikdoe->description}}</textarea>                                                        </div>
