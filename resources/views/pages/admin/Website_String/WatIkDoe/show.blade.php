                                ...
                                <!--/Setting-->
                                   ...
                                   <div class="row">
                                        <div class="col-md-12" style="max-width: 50%;">
                                            ...
                                            <input type="text" class="form-control view" value="{{$website_watikdoe->titel}}"  disabled/>
                                            </div>

                                            <div class="form-group">
                                            <label for="name">Description</label>
                                            <textarea   class="form-control view"  value="{{$website_watikdoe->description}}" disabled  rows="4" cols="50">{{$website_watikdoe->description}}</textarea>
                                            </div>
