                                   ...
                                   <div class="row">
                                          <div class="col-md-12" style="max-width: 50%;">
                                            ...
                                            <div class="form-group">
                                                <a href="{{route('auth.dashboard.contact')}}" class="btn btn-default pull-right breadcrumb-item "> <i class="	fa fa-angle-double-left"> Terug naar Alle Contacten   </a></i> 
                                            </div>

                                            <div class="form-group">
                                            <label for="name">name</label>
                                            <input type="text"  class="form-control view " value="{{$contact_strings->name}}"  disabled/>
                                            </div>
                                            <div class="form-group">
                                            <label for="name">email</label>
                                            <input type="text" class="form-control view " value="{{$contact_strings->email}}"  disabled />
                                            </div>
                                            <div class="form-group">
                                            <label for="name">Messege</label>
                                            <input type="text" class="form-control view " value="{{$contact_strings->message}}" disabled />
                                            </div>
