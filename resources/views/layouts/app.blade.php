...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}" style="color: rgb(0 152 212);font-size: 18px;font-weight: 700;"><img src="/img/admin/logo_site.png" alt="login_img"  width="50" height="50">
                   Ibrahim  Sadour
                </a>
