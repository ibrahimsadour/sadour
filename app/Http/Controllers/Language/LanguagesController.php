...
use App\Http\Requests\AdminDashboard\LanguagesRequest;
...
class LanguagesController extends Controller
{
    public function index(){
        ...
        // return $languages;
        return view('pages.admin.Website_String.Language.index', compact('languages'));
    }

    public function create(){
        
        return view('pages.admin.Website_String.Language.Add');
    }
